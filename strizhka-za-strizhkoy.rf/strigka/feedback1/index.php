...
'fields' => array(
  ...
  'cfg' => array(
    ...
    'from_name' => 'Стрижка за стрижкой',
    'to_email' => 'q18051977@gmail.com',
    'to_name' => 'Менеджер',
    'geoip' => true,
    'referer' => true,
    'type' => 'plain',
    ...
    'okay' => 'Спасибо большое за Вашу заявку, мы свяжемся с Вами в ближайшее время!',
...
'fields' => array(
  ...
  'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'Заказ покрытие гель-лаком, маникюр + педикюр',
    'title' => 'Новая заявка',
    'ajax' => true,
    'validate' => true,
      'from_email' => 'noreply@email.com',
...
'fields' => array(
  ...
  'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'Заказ сделай стрижку и получи купон',
    'title' => 'Новая заявка',
    'ajax' => true,
    'validate' => true,
      'from_email' => 'noreply@email.com',
...
'fields' => array(
  ...
  'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'Заказ любой сеанс загара за 39 рублей',
    'title' => 'Новая заявка',
    'ajax' => true,
    'validate' => true,
      'from_email' => 'noreply@email.com',
