...
<body>
   ...
   <div id="wb_Shape10">
      <img src="images/img0013.png" id="Shape10" alt="">
   </div>
   <div id="wb_Form2">
      <form name="Form1" method="post" action="<?php echo basename(__FILE__); ?>" enctype="multipart/form-data" accept-charset="UTF-8" target="_top" id="Form2">
         ...
         <input type="text" id="Editbox2" onmouseover="Animate('Shape7', '', '', '', '', '100', 500, '');return false;" onmouseout="Animate('Shape7', '', '', '', '', '70', 500, '');return false;" name="Editbox2" value="" placeholder="&#1074;&#1072;&#1096; &#1090;&#1077;&#1083;&#1077;&#1092;&#1086;&#1085;">
         <input type="text" id="Editbox3" onmouseover="Animate('Shape8', '', '', '', '', '100', 500, '');return false;" onmouseout="Animate('Shape8', '', '', '', '', '70', 500, '');return false;" name="Editbox3" value="" placeholder="&#1091;&#1076;&#1086;&#1073;&#1085;&#1086;&#1077; &#1074;&#1088;&#1077;&#1084;&#1103; &#1076;&#1083;&#1103; &#1079;&#1074;&#1086;&#1085;&#1082;&#1072;">
         <input type="submit" id="Button1" onmouseover="Animate('Shape6', '', '', '', '', '100', 2500, '');Animate('Shape7', '', '', '', '', '100', 1500, '');Animate('Shape8', '', '', '', '', '100', 500, '');return false;" onmouseout="Animate('Shape6', '', '', '', '', '70', 2500, '');Animate('Shape7', '', '', '', '', '70', 1500, '');Animate('Shape8', '', '', '', '', '70', 500, '');return false;" name="" value="Перезвоните мне">
         <div id="wb_Image4">
            <img src="images/icon-person.png" id="Image4" alt=""></div>
         <div id="wb_Image5">
            <img src="images/icon-phone.png" id="Image5" alt=""></div>
         <div id="wb_Image6">
            <img src="images/icon-time.png" id="Image6" alt=""></div>
      </form>
   </div>
   <div id="wb_Text3">
      <span id="wb_uid1">Заказ обратного звонка</span>
   </div>
   <div id="wb_Text24">
...
<span id="wb_uid3">ваш телефон:</span>
   ...
   <div id="wb_Text26">
<span id="wb_uid4">удобное время для звонка:</span>
   </div>
</body>
</html>