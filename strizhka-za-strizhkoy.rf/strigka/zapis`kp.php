...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['formid'] == 'form1')
{
   ...
   $subject = 'заявка_запись';
   $message = 'заявка_запись';
...
<!-- /Yandex.Metrika counter -->
   ...
   <div id="container">
      <div id="wb_Shape1">
         <img src="images/img0068.png" id="Shape1" alt="">
      </div>
      <div id="wb_Form1">
      ...
      <div id="wb_Text11">
         <span id="wb_uid1"><strong>ОСТАВЬТЕ ЗАЯВКУ</strong></span><span id="wb_uid2"><br></span><span id="wb_uid3">и мы свяжемся с Вами <br>в ближайшее время</span>
      </div>
   </div>
<!-- Yandex.Metrika counter -->
<script type="text/javascript">
