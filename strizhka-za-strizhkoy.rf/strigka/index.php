...
<head>
	<meta charset="utf-8" />
	<title>Сеть парикмахерских в Перми</title>
	...
	<header>
		...
		<div class="mainhead">
			...
			<span style="color: rgb(86, 72, 58); font-size: 26px; line-height: 38px;"><a style="color: rgb(86, 72, 58);" href="" class="chkbtn choose_btn" data-id="4">Воронеж</a></span>
				...
				<div class="phone">
					<a href="https://vk.com/szs_perm" target="_blank">
	...
	<section class="adrsect">
		...
		<div class="addrwrap2 chaik">
			...
			<div class="addrcont">
				...
				<p class="phonetxt">
					<span>тел.:</span>
					<img src="img1/plus.png"  style="height: 12px; vertical-align: middle; margin-left: 5px;" alt="">7 342 144 20 80</p>
				<p class="schedtxt">
					<span style="letter-spacing: normal;">с</span>
					9
					<span style="margin-right: 5px; letter-spacing: 1px;">до</span>
...
<div class="modal">
	...
	<script type="text/javascript" src="https://w73458.yclients.com/widgetJS" charset="UTF-8"></script>
...
<script type="text/javascript">
VK.Widgets.CommunityMessages("vk_community_messages", 59281852, {expandTimeout: "30000",widgetPosition: "left",tooltipButtonText: "Есть вопрос?"});
</script>
</body>
</html>