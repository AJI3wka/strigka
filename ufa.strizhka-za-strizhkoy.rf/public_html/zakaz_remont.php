...
{
   $mailto = 'andreymail18@gmail.ru';
   $mailfrom = isset($_POST['email']) ? $_POST['email'] : $mailto;
   $subject = 'Заказ услуги ремонт';
   $message = 'Заказ услуги ремонт';
...
#Button1
{
   ...
   background-color: transparent;
   background-image: url(images/YHFFTT.png);
...
<!-- /Yandex.Metrika counter -->
   ...
   <div id="container">
      <div id="wb_Shape1">
         <img src="images/img0107.png" id="Shape1" alt="">
      </div>
      <div id="wb_Form1">
      ...
      <div id="wb_Text11">
         <span id="wb_uid1"><strong>ЗАКАЗ УСЛУГИ</strong></span><span id="wb_uid2"><br></span><span id="wb_uid3">наши менеджеры свяжутся с Вами в ближайшее время</span>
      </div>
      <hr id="Line1">
   </div>
<!-- Yandex.Metrika counter -->
