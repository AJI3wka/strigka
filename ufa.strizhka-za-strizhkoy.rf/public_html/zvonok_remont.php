...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['formid'] == 'form1')
{
   ...
   $subject = 'Обратный звонок ремонт';
   $message = 'Обратный звонок ремонт';
...
<!-- /Yandex.Metrika counter -->
   ...
   <div id="container">
      <div id="wb_Shape1">
         <img src="images/img0102.png" id="Shape1" alt="">
      </div>
      <div id="wb_Form1">
      ...
      <div id="wb_Text11">
         <span id="wb_uid1"><strong>ЗАКАЖИТЕ ЗВОНОК</strong></span><span id="wb_uid2"><br></span><span id="wb_uid3">и мы свяжемся с Вами <br>в ближайшее время</span>
      </div>
      <hr id="Line1">
   </div>
<!-- Yandex.Metrika counter -->
