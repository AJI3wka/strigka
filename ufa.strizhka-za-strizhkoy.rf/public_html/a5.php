...
<span id="wb_uid4"><strong>оставить заявку</strong></span></div>
            ...
            <div id="wb_Text26">
<span id="wb_uid5">ваш телефон:</span></div>
         </form>
      </div>
      <div id="wb_Text9">
<span id="wb_uid6"><em>просто оставьте ваше имя,<br>телефон и e-mail в форме ниже</em></span>
      ...
      <div id="wb_Shape6">
         <img src="images/img0013.png" id="Shape6" alt="">
      </div>
      <div id="wb_Text22">
<span id="wb_uid7">Не пропустите отличный продукт по супер цене,<br><strong> </strong></span><span id="wb_uid8"><strong>оставьте заявку сейчас!</strong></span>
      </div>
      <div id="wb_Image33">
         <img src="images/img0014.png" id="Image33" alt="">
      </div>
      <div id="wb_InlineFrame8">
         <a id="InlineFrame8" title="Оставить заявку" href="./callback.php?iframe"><img src="images/btnz.png" id="wb_uid9" alt="Оставить заявку"></a>
      </div>
      <div id="wb_Text39">
         <span id="wb_uid10">Copyright © 2014. Все права защищены. ИП Егоров А. А. ОГРН 313590319600015<br> служба поддержки клиентов szs1@bk.ru Ваши данные не будут переданы третьим лицам.<br><a href="./price.php">соглашение о политике кониденциальности</a></span>
      </div>
      <div id="wb_Text24">
<span id="wb_uid11">ваше имя:</span>
      </div>
      <div id="wb_Text25">
<span id="wb_uid12">ваш e-mail:</span>
      </div>
      <div id="wb_Image38">
         <img src="images/badge4.png" id="Image38" alt="">
      </div>
      <div id="wb_Text28">
<span id="wb_uid13"><em>скидка до конца дня</em></span>
      </div>
      <div id="wb_Text1">
         <span id="wb_uid14"><strong>ОКРАШИВАНИЕ </strong></span><span id="wb_uid15"><strong>MATRIX </strong></span><span id="wb_uid16"><strong><br>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; ПО ЦЕНЕ </strong></span><span id="wb_uid17"><strong>ESTEL </strong></span>
      </div>
      <div id="wb_Text2">
         <span id="wb_uid18"><strong>скидка<br> на<br> окрашивание<br> до 50%</strong></span>
      </div>
   </div>
